...
##for z in range(shape(img_list1)[0]):
...
##   scipy.misc.imsave('/mnt/ssd/shamir/Original Images/Good Images/No Counts/LCN/Training_Set/'+ img_list1[z], im_eq)
...
##   # save image
##   scipy.misc.imsave('/mnt/ssd/shamir/Original Images/Good Images/No Counts/Traninig_Set_LCN_Labelled/'+ img_list2[z], im_final_morph_label)
